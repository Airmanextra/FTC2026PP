 ...
 * 
 * Combines LimelightVision with ShooterKinematics for intelligent shooting.
 */
public class SmartShooter {
    ...
    public SmartShooter(HardwareMap hardwareMap, String shooterMotorName) {
        ...
        try {
            ...
            throw new IllegalArgumentException("Could not find shooter motor: " + shooterMotorName);
        }
    }
    ...
    private boolean setVelocityForTarget(double verticalAngle) {
        ...
        // Set motor velocity
        shooterMotor.setVelocity(rpm * 28);  // Convert to ticks per second (28 ticks/rev for many motors)
    ...
    public void setShooterRPM(double rpm) {
        shooterMotor.setVelocity(rpm * 28);  // Adjust ticks per revolution for your motor
    }
    ...
    public double getCurrentRPM() {
        return shooterMotor.getVelocity() / 28;  // Adjust for your motor
    }
    ...
    /**
     * Gets the shooter motor for direct access.
     * 
