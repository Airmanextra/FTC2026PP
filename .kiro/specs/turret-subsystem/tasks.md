...
- [-] 1. Create Turret class structure and initialization
...
- [~] 2. Implement core power control methods
  - [~] 2.1 Implement clampPower private method
    - Clamp power values to [-1.0, 1.0] range
    - _Requirements: 2.4_
  
  - [~] 2.2 Implement setPower method
...
- [~] 2.4 Write property test for power clamping
  - **Property 2: Power Clamping**
  - **Validates: Requirements 2.4**

- [~] 2.5 Write property test for synchronized servo power
  - **Property 3: Synchronized Servo Power**
  - **Validates: Requirements 2.1, 2.2, 2.3, 2.5**

- [~] 2.6 Write unit test for stop method
  - Test that stop() sets power to zero
  - _Requirements: 3.1_

- [~] 3. Implement convenience rotation methods
  - [~] 3.1 Implement rotateLeft method
    - Accept speed parameter
    - Call setPower with positive speed value
    - _Requirements: 4.1, 4.3_
  
  - [~] 3.2 Implement rotateRight method
    - Accept speed parameter
    - Call setPower with negative speed value
    - _Requirements: 4.2, 4.4_

- [~] 3.3 Write property test for left rotation direction
  - **Property 4: Left Rotation Direction**
  - **Validates: Requirements 4.1, 4.3**

- [~] 3.4 Write property test for right rotation direction
  - **Property 5: Right Rotation Direction**
  - **Validates: Requirements 4.2, 4.4**

- [~] 4. Implement telemetry and state methods
  - [~] 4.1 Implement getCurrentPower method
    - Return currentPower field value
    - _Requirements: 5.1_
  
  - [~] 4.2 Implement getDirection method
    - Return "LEFT" for positive power
    - Return "RIGHT" for negative power
    - Return "STOPPED" for zero power
    - _Requirements: 5.2_

- [~] 4.3 Write property test for state consistency
  - **Property 6: State Consistency**
  - **Validates: Requirements 5.1, 5.2, 5.3**

- [~] 4.4 Write unit tests for getDirection edge cases
  - Test direction strings for specific power values (0, 0.5, -0.5)
  - _Requirements: 5.2_

- [~] 5. Create example OpMode for testing
